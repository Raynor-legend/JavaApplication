...
public class quanlimenu extends JFrame {
	...
	private String arr_listmenu[] = { "Quản lí nhân viên", "Quản lí khách hàng", "Hóa đơn", "Nhập sản phẩm",
			"Hóa đơn nhập nước uống", "Thống kê" };
	...
	private JPanel pn_nhapSanpham = new JPanel();
