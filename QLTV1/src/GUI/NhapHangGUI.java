            ...
            do {
                ...
                if (soLuongThemStr != null) {
                    ...
                    if ((soLuongThem <= sLSP) && (soLuongThem != 0)) {
                        ...
                        //Kiá»ƒm tra sáº£n pháº©m Ä‘Ã£ tá»“n táº¡i trong giá»� hÃ ng hay chÆ°a, náº¿u cÃ³ thÃ¬ tÄƒng sá»‘ lÆ°á»£ng
                        if (tblCTHDNhap.getRowCount() == 0) {
                            Object[] row = {tblCTHDNhap.getRowCount() + 1, maSP, tenSP, donGiaSP, soLuongThem, String.valueOf(thanhTien)};
                            modelCTHDNhap.addRow(row);
                        } else {
                            checkDaCo = 0;
                            for (int i = 0; i < tblCTHDNhap.getRowCount(); i++) {
                                ...
                                if (maSP == tblCTHDNhap.getValueAt(i, 1).toString()) {
                                    ...
                                    tblCTHDNhap.setValueAt(soLuongDaCo + soLuongThem, i, 3); //Thay Ä‘á»•i sá»‘ lÆ°á»£ng
                                    tblCTHDNhap.setValueAt(((soLuongDaCo + soLuongThem) * donGiaSP), i, 5);//Thay Ä‘á»•i thÃ nh tiá»�n
                                    break;
                                }
                            }
                            if (checkDaCo != 1) {
        ...
        if (tblCTHDNhap.getRowCount() != 0) {
            ...
            try {
                for (int i = 0; i < tblCTHDNhap.getRowCount(); i++) {
                    ...
                    chitiethdNhapDTO.setMaSach(tblCTHDNhap.getValueAt(i, 1).toString());
                    chitiethdNhapDTO.setTenSach(tblCTHDNhap.getValueAt(i, 2).toString());
                    ...
                    for (int k = 0; k < tblSP.getRowCount(); k++) {
                        String maSachCT = tblCTHDNhap.getValueAt(i, 1).toString();
