...
//        p2.add(scroll);
	...
	private void ThemGioHang() {
		...
		if (tblSP.getSelectedRow() != -1) {
			...
			JOptionPane.showMessageDialog(null, "Vui lòng chọn nước uống muốn thêm");
		}
	...
	private void xoaCTHD() {
		...
		if (tblCTHD.getSelectedRow() != -1) {
			...
			JOptionPane.showMessageDialog(null, "Chưa chọn nước uống cần xoá");
		}
...
//                    txMaNV.setText("");
			...
			JOptionPane.showMessageDialog(null, "Vui lòng chọn nước uống!");
		}
		DefaultTableModel modelCTHD = (DefaultTableModel) tblCTHD.getModel();
