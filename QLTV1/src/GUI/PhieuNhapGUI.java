...
public class PhieuNhapGUI extends JPanel implements ActionListener, MouseListener {
    ...
    public JPanel p2, p3;
    Vector header;
    public static ArrayList<SachDTO> kq;
...
//                    if ((soLuongThem <= sLSP) && (soLuongThem != 0)) {
                    ...
                    if (DonGiaStr != null) {
                        ...
                        if (tblCTHDNhap.getRowCount() == 0) {
                            Object[] row = {tblCTHDNhap.getRowCount() + 1, maSP, tenSP, DonGia, soLuongThem, String.valueOf(thanhTien)};
...
//                    txMaNV.setText(""); 
                ...
                JOptionPane.showMessageDialog(null, "Vui lòng chon sản phẩm");
            }
            DefaultTableModel modelCTHDNhap = (DefaultTableModel) tblCTHDNhap.getModel();
